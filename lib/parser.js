...
//  description: String,
//  date: 'YYYY-MM-DD',
//  ssPresent: true|false, // StaticSearch client script found
//  word: {
//    title: Set(),
//    description: Set(),
//    content: Set(),
...
export function parseHTML(
  ...
  // static search client present?
  res.ssPresent = !!dom.querySelector('script[src*="staticsearch"]');

  // extract words
  res.word = {
    title: wSet( res.title ),
    description: wSet( res.description ),
    keywords: wSet( (dom.querySelector('meta[name="keywords"]')?.getAttribute('content') || '').trim() ),
    content: new Set(),
    emphasis: new Set(),
    alt: new Set(),
    h2: new Set(),
